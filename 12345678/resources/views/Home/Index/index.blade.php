...
<head>
	...
	<!-- Custom Fonts -->
    <link rel="stylesheet" href="{{ asset('Home/font-awesome/css/font-awesome.min.css') }}"  type="text/css">
    <link rel="stylesheet" href="{{ asset('Home/fonts/font-slider.css') }}" type="text/css">
	...
	<div id="page-content" class="home-page">
		<div class="container">
					...
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img src="{{ asset('Home/images/main-banner1-1903x600.jpg') }}" alt="First slide">
								<!-- Static Header -->
							...
							<div class="item">
								<img src="{{ asset('Home/images/main-banner2-1903x600.jpg') }}" alt="Second slide">
								<!-- Static Header -->
								<div class="header-text hidden-xs">
									<div class="col-md-12 text-center">
									</div>
							...
							<div class="item">
								<img src="{{ asset('Home/images/main-banner3-1903x600.jpg') }}" alt="Third slide">
								<!-- Static Header -->
								<div class="header-text hidden-xs">
									<div class="col-md-12 text-center">
									</div>
			...
			<div class="row">
				<div class="banner">
					<div class="col-sm-4">
						<img src="{{ asset('Home/images/sub-banner1.png') }}" />
					</div>
					<div class="col-sm-4">
						<img src="{{ asset('Home/images/sub-banner2.png') }}" />
					</div>
					<div class="col-sm-4">
						<img src="{{ asset('Home/images/sub-banner3.png') }}" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="products">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="product.html"><img src="{{ asset('Home/images/iphone.png') }}" /></a></div>
								<div class="buttons">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="product.html"><img src="{{ asset('Home/images/galaxy-s4.jpg') }}" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="product.html"><img src="{{ asset('Home/images/galaxy-note.jpg') }}" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="product.html"><img src="{{ asset('Home/images/Z1.png') }}" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
			...
			<div class="row">
				<div class="banner">
					<div class="col-sm-6">
						<img src="{{ asset('Home/images/sub-banner4.jpg') }}" />
					</div>
					<div class="col-sm-6">
						<img src="{{ asset('Home/images/sub-banner5.png') }}" />
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="wrap-footer">
				<div class="row">
					<div class="col-md-3 col-footer footer-1">
						<img src="{{ asset('Home/images/logofooter.png') }}" />
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="pull-right">
							<ul>
								<li><img src="{{ asset('Home/images/visa-curved-32px.png') }}" /></li>
								<li><img src="{{ asset('Home/images/paypal-curved-32px.png') }}" /></li>
								<li><img src="{{ asset('Home/images/discover-curved-32px.png') }}" /></li>
								<li><img src="{{ asset('Home/images/maestro-curved-32px.png') }}" /></li>
							</ul>
						</div>
					</div>
				</div>
