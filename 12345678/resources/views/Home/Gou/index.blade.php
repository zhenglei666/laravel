             ...
             @endforeach
              ...
              <form action="" method="post" name='myform'>
                {{ csrf_field() }}
                  ...
                  <input style="300px" value="{{ ($o->productmoney)*($o->num) }}" type="hidden" name='money' >
     ...
     <div class="brick-shadow fee-list">
              ...
              <ul>
                ...
                <li>
                  ...
                  <span class="fee-list-data" id="trade_total_fee">￥<font>{{ ($o->productmoney)*($o->num) }}</font></span>
                </li>
                <li>
                ...
                <li>
                  <span class="fee-list-title">应付金额：</span>
                                      <span class="fee-list-data fee-list-amount" id="amount_fee_price">￥{{ ($o->productmoney)*($o->num) }}</span>
                                  </li>
